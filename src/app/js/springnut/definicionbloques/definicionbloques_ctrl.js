...
angular.module('definicionbloquesTypes').controller( 'DefinicionbloquesCtrl', [
    'DefinicionbloquesCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
function ( theSS_DefinicionbloquesCtrlType,
    ...
    $scope.definicionbloquesCtrl = new theSS_DefinicionbloquesCtrlType.DefinicionbloquesCtrl_Constructor(
        "Definicionbloques_Controller",
        theSS_IdentifierSvce,
        theSS_RecorderSvce,
        $scope,
        null,
    ...
    $scope.compositeCtrl = $scope.definicionbloquesCtrl;


    $scope.definicionbloquesCtrl.fprDo_Initial();
