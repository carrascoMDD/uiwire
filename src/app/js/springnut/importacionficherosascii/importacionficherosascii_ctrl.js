...
/*
 * importacionficherosascii_ctrl.js
 *
...
angular.module('importacionficherosasciiTypes').controller( 'ImportacionficherosasciiCtrl', [
    'ImportacionficherosasciiCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
function ( theSS_ImportacionficherosasciiCtrlType,
    ...
    $scope.importacionficherosasciiCtrl = new theSS_ImportacionficherosasciiCtrlType.ImportacionficherosasciiCtrl_Constructor(
        "Importacionficherosascii_Controller",
        theSS_IdentifierSvce,
        theSS_RecorderSvce,
        $scope,
        null,
    ...
    $scope.compositeCtrl = $scope.importacionficherosasciiCtrl;


    $scope.importacionficherosasciiCtrl.fprDo_Initial();

    $scope.trabajosCtrl = $scope.importacionficherosasciiCtrl;
