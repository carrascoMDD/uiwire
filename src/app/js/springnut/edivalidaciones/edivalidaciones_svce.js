...
angular.module("edivalidacionesTypes").factory("EdivalidacionesSvce", [
    "EdivalidacionesSvceType",
    "IdentifierSvce",
    "RecorderSvce",
function( theSS_EdivalidacionesSvceType,
          theSS_IdentifierSvce,
          theSS_RecorderSvce){

    var aService = new theSS_EdivalidacionesSvceType.EdivalidacionesSvce_Constructor(
        "Edivalidaciones_Service",
        theSS_IdentifierSvce,
        theSS_RecorderSvce
    );
    if( aService){}/* CQT */
