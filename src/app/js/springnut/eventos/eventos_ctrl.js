...
angular.module('eventosTypes').controller( 'EventosCtrl', [
    'EventosCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
function ( theSS_EventosCtrlType,
    ...
    $scope.eventosCtrl = new theSS_EventosCtrlType.EventosCtrl_Constructor(
        "Eventos_Controller",
        theSS_IdentifierSvce,
        theSS_RecorderSvce,
        $scope,
    ...
    $scope.compositeCtrl = $scope.eventosCtrl;


    $scope.eventosCtrl.fprDo_Initial();
