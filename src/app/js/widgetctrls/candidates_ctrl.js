...
angular.module('widgetCtrlsTypes').controller( 'CandidatesCtrl', [
    'CandidatesCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
function ( theSS_CandidatesCtrlType,
    ...
    $scope.candidatesCtrl = new theSS_CandidatesCtrlType.CandidatesCtrl_Constructor(
