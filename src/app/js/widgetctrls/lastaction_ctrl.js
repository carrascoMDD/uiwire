...
angular.module('widgetCtrlsTypes').controller( 'LastActionCtrl', [
    'LastActionCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
    function ( theSS_LastActionCtrlType,
    ...
    $scope.lastActionCtrl = new theSS_LastActionCtrlType.LastActionCtrl_Constructor(
        "LastAction_Controller",
        theSS_IdentifierSvce,
        theSS_RecorderSvce,
        $scope
    );

    $scope.lastActionCtrl.fprDo_Initial();
