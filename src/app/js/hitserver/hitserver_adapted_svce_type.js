...
function( theSS_typesregistry,
          ...
          theSS_HitAdapterBackandSvceType){
    ...
    var aMod_definer = function( theS_Overrider,
                                 ...
                                 theS_HitAdapterBackandSvceType) {
        ...
        var aHitServerAdaptedSvce_Prototype = (function() {
            ...
            var pInitHitAdapter = function( ) {
                if( theS_BackandUse.fBackandUse()) {

                    this._v_HitAdapter = new theS_HitAdapterBackandSvceType.HitAdapterBackandSvce_Constructor(
                        "(HitAdapter-Backand-For-" + this._v_Title + ")",
                        this._v_Identifier,
                        this._v_Recorder,
                        this
                    );
