...
/*
 * importacionficherosascii_svce.js
 *
...
angular.module("importacionficherosasciiTypes").factory("ImportacionficherosasciiSvce", [
    "ImportacionficherosasciiSvceType",
    "IdentifierSvce",
    "RecorderSvce",
function( theSS_ImportacionficherosasciiSvceType,
          theSS_IdentifierSvce,
          theSS_RecorderSvce){

    var aService = new theSS_ImportacionficherosasciiSvceType.ImportacionficherosasciiSvce_Constructor(
        "Importacionficherosascii_Service",
        theSS_IdentifierSvce,
        theSS_RecorderSvce
    );
    if( aService){}/* CQT */
