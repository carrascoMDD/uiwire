...
/*
 * adminoperadores_instrumentacion_ctrl.js
 *
...
angular.module('springnut').controller( 'AdminoperadoresInstrumentacionCtrl', [
    'AdminoperadoresInstrumentacionCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
    function ( theSS_AdminoperadoresInstrumentacionCtrlType,
        ...
        $scope.adminoperadoresCtrl = new theSS_AdminoperadoresInstrumentacionCtrlType.AdminoperadoresInstrumentacionCtrl_Constructor(
            "AdminoperadoresInstrumentacion_Controller",
            theSS_IdentifierSvce,
            theSS_RecorderSvce,
            $scope
        );
