...
var aUIWIREjsApp = angular.module('springnut');

aUIWIREjsApp.directive('uiTree', function() {
    return {
        ...
        link: function(scope, elm, attrs) {
            ...
            scope.toggleNode = function(nodeId) {
                ...
                if(!isVisible && scope.loadFn && childrenTree.length === 0) {
                    ...
                    var imgUrl = "app/img/ajax-loader.gif";
...
aUIWIREjsApp.directive('smartFloat', function() {
...
aUIWIREjsApp.directive('numeric', function($filter, $locale) {
    return {
        restrict: 'A',
        require: 'ngModel',
...
aUIWIREjsApp.directive('numericOrig', function($filter, $locale) {
    return {
        restrict: 'A',
        require: 'ngModel',
        link: function(scope, element, attr, ngModel) {
...
aUIWIREjsApp.directive('ngEnter', function() {
