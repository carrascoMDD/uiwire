...
angular.module("fasesvalidacionTypes").factory("FasesvalidacionSvce", [
    "FasesvalidacionSvceType",
    "IdentifierSvce",
    "RecorderSvce",
function( theSS_FasesvalidacionSvceType,
          theSS_IdentifierSvce,
          theSS_RecorderSvce){

    var aService = new theSS_FasesvalidacionSvceType.FasesvalidacionSvce_Constructor(
        "Fasesvalidacion_Service",
        theSS_IdentifierSvce,
        theSS_RecorderSvce
    );
    if( aService){}/* CQT */
