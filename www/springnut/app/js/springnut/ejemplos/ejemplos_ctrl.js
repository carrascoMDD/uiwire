...
angular.module('ejemplosTypes').controller( 'EjemplosCtrl', [
    'EjemplosCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
function ( theSS_EjemplosCtrlType,
    ...
    $scope.ejemplosCtrl = new theSS_EjemplosCtrlType.EjemplosCtrl_Constructor(
        "Ejemplos_Controller",
        theSS_IdentifierSvce,
        theSS_RecorderSvce,
        $scope,
    ...
    $scope.compositeCtrl = $scope.ejemplosCtrl;


    $scope.ejemplosCtrl.fprDo_Initial();
