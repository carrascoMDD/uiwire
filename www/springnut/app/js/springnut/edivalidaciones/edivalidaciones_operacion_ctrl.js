...
/*
 * edivalidaciones_operacion_ctrl.js
 *
 * Creado @author Antonio Carrasco Valero 201410281906
 *
 *
 ***************************************************************************
...
angular.module('springnut').controller( 'EdivalidacionesOperacionCtrl', [
    'EdivalidacionesOperacionCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
function ( theSS_EdivalidacionesOperacionCtrlType,
    ...
    $scope.edivalidacionesCtrl = new theSS_EdivalidacionesOperacionCtrlType.EdivalidacionesOperacionCtrl_Constructor(
        "EdivalidacionesOperacion_Controller",
        theSS_IdentifierSvce,
        theSS_RecorderSvce,
        $scope
    );
