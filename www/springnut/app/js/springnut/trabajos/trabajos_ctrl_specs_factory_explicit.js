...
/*
 * trabajos_ctrl_specs_factory_explicit.js
 *
...
angular.module("trabajosTypes").factory("TrabajosCtrlSpecsFactoryExplicit", [
    "TypesRegistrySvce",
    "OverriderSvce",
    "IdentifierSvce",
    "RecorderSvce",
    ...
    function( theSS_typesregistry,
              ...
              theSS_TrabajosCtrlSpecsTobefilled) {




        var ModuleName     = "trabajos_ctrl_specs_factory_explicit";
        ...
        var aMod_definer = function( theS_Overrider,
                                     ...
                                     theS_TrabajosCtrlSpecsTobefilled) {
            ...
            var pgInitWithModuleConstants = function( theToInit) {
                ...
                theToInit.RETRIEVALSFORGRIDNAMES = {
                    "ListaTrabajos":  "fprDo_Trabajos_ListaTrabajosLigera"
                };
            ...
            var fsCtrlSpecs = function( theIsInstrumentacion) {
                ...
                var aSourceCtrlSpecs = theS_TrabajosCtrlSpecsTobefilled.CTRLSPECS;
                if( !aSourceCtrlSpecs) {
                    return null;
                }
                ...
                aCtrlSpecsToReturn.GRIDNAMES_INITIALLOAD = [ ];
