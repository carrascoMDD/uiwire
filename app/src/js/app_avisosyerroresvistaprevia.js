...
/*
 * app_avisosyerroresvistaprevia.js
 *
 * Creado @author Antonio Carrasco Valero 201411101915
 *
 *
 ***************************************************************************
...
angular.module('springnut',
    [
        ...
        'avisosyerroresvistapreviaTypes'
    ]
);
...
angular.module('springnut').config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider
        ...
        .when('/avisosYerroresVistaPrevia', {templateUrl: 'partials/fasesvalidacion/avisosyerroresvistaprevia.html', controller: 'AvisosyerroresvistapreviaCtrl'})

        .otherwise({redirectTo: '/avisosYerroresVistaPrevia'});
