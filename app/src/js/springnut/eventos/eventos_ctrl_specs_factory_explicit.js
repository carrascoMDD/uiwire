...
/*
 * eventos_ctrl_specs_factory_explicit.js
 *
...
angular.module("eventosTypes").factory("EventosCtrlSpecsFactoryExplicit", [
    "TypesRegistrySvce",
    "OverriderSvce",
    "IdentifierSvce",
    "RecorderSvce",
    ...
    function( theSS_typesregistry,
              ...
              theSS_CssKeys,
              theSS_CssNames_Springnut_Eventos,
              theSS_EventosCtrlSpecsTobefilled) {




        var ModuleName     = "eventos_ctrl_specs_factory_explicit";
        ...
        var aMod_definer = function( theS_Overrider,
                                     ...
                                     theS_CssKeys,
                                     theS_CssNames_Springnut_Eventos,
                                     theS_EventosCtrlSpecsTobefilled) {
            ...
            var pgInitWithModuleConstants = function( theToInit) {
                ...
                theToInit.DEFAULTTITLE = "EventosCtrlDefaultName";



                theToInit.EVENTOS_DOMIDPREFIX = "didSpringnut_Eventos";

                theToInit.EVENTOS_PAGEHEADER = "Eventos";



                theToInit.RETRIEVALTARGET = "fEventosSvce";


                theToInit.RETRIEVALSFORGRIDNAMES = {
                    "ListaExcepciones":        "fprDo_Excepciones_ListaExcepcionesRecientes_Wrapper",
                    "ListaAccesosoperadores":  "fprDo_Accesosoperadores_ListaAccesosoperadoresRecientes_Wrapper",
                    "ListaAccesosfallidos":    "fprDo_Accesosfallidos_ListaAccesosfallidosRecientes_Wrapper",
                    "ListaLecturasboletines":  "fprDo_Lecturasboletines_ListaLecturasboletinesRecientes_Wrapper",
                    "ListaCambios":            "fprDo_Cambios_ListaCambiosRecientesConTipos_Wrapper"
                };
            ...
            var fsCtrlSpecs = function( theIsInstrumentacion) {
                ...
                var aSourceCtrlSpecs = theS_EventosCtrlSpecsTobefilled.CTRLSPECS;
                if( !aSourceCtrlSpecs) {
                    return null;
                }
                ...
                var aCsssFilledCtrlSpecs = aFillspecsSvce.fFillSpecsCsss(
                    aSourceCtrlSpecs,
                    theS_CssNames_Springnut_Eventos.CSSs_SPRINGNUT_EVENTOS_TABLE,
                    theS_CssNames_Springnut_Eventos.CSSs_SPRINGNUT_EVENTOS_EDITOR
                );
                ...
                aCtrlSpecsToReturn.EVENTOS_DOMIDPREFIX = aModule.EVENTOS_DOMIDPREFIX;
                aCtrlSpecsToReturn.DOMIDPREFIX         = aCtrlSpecsToReturn.EVENTOS_DOMIDPREFIX;

                aCtrlSpecsToReturn.EVENTOS_PAGEHEADER =  aModule.EVENTOS_PAGEHEADER;
