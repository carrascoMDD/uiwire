...
angular.module("cssNames_Springnut_Eventos", [
    "typesRegistry",
    "cssKeys",
    "cssNames_Springnut"
]).
factory("CssNames_Springnut_Eventos", [
    "TypesRegistrySvce",
    "CssKeys",
    "CssNames_Springnut",
function( theSS_typesregistry,
    ...
    var ModuleName     = "cssnames_eventos";
    ...
    var aMod_definer = function( theS_CssKeys,
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.CSSs_SPRINGNUT_EVENTOS_TABLE = { };
            ...
            for( var aGridClassKeyIdx=0; aGridClassKeyIdx < aNumGridClassKeys; aGridClassKeyIdx++) {
                ...
                theToInit.CSSs_SPRINGNUT_EVENTOS_TABLE[ aGridClassKey] = theS_CssNames_Springnut.CSSs_SPRINGNUT_TABLE[ aGridClassKey];
            }



            theToInit.CSSs_SPRINGNUT_EVENTOS_EDITOR = { };
            ...
            for( var anEditorClassKeyIdx=0; anEditorClassKeyIdx < aNumEditorClassKeys; anEditorClassKeyIdx++) {
                ...
                theToInit.CSSs_SPRINGNUT_EVENTOS_EDITOR[ anEditorClassKey] = theS_CssNames_Springnut.CSSs_SPRINGNUT_EDITOR[ anEditorClassKey];
            }
        };
