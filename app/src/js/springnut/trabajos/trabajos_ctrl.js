...
angular.module('trabajosTypes').controller( 'TrabajosCtrl', [
    'TrabajosCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
function ( theSS_TrabajosCtrlType,
    ...
    $scope.trabajosCtrl = new theSS_TrabajosCtrlType.TrabajosCtrl_Constructor(
        "Trabajos_Controller",
        theSS_IdentifierSvce,
        theSS_RecorderSvce,
        $scope,
    ...
    $scope.compositeCtrl = $scope.trabajosCtrl;


    $scope.trabajosCtrl.fprDo_Initial();
