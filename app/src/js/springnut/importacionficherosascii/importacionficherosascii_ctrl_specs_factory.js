...
/*
 * importacionficherosascii_ctrl_specs_factory.js
 *
...
angular.module("importacionficherosasciiTypes").factory("ImportacionficherosasciiCtrlSpecsFactory", [
    "TypesRegistrySvce",
    "OverriderSvce",
    "IdentifierSvce",
    "RecorderSvce",
    "FillspecsSvceType",
    "CssKeys",
    "CssNames_Springnut_Importacionficherosascii",
    "ImportacionficherosasciiCtrlSpecsTobefilled",
    function( theSS_typesregistry,
              ...
              theSS_CssKeys,
              theSS_CssNames_Springnut_Importacionficherosascii,
              theSS_ImportacionficherosasciiCtrlSpecsTobefilled) {




        var ModuleName     = "importacionficherosascii_ctrl_specs_factory";
        ...
        var aMod_definer = function( theS_Overrider,
                                     ...
                                     theS_CssKeys,
                                     theS_CssNames_Springnut_Importacionficherosascii,
                                     theS_ImportacionficherosasciiCtrlSpecsTobefilled) {
            ...
            var pgInitWithModuleConstants = function( theToInit) {
                ...
                theToInit.DEFAULTTITLE = "ImportacionficherosasciiCtrlDefaultName";



                theToInit.IMPORTACIONFICHEROSASCII_DOMIDPREFIX = "didSpringnut_Importacionficherosascii";
                theToInit.DOMIDPREFIX = theToInit.IMPORTACIONFICHEROSASCII_DOMIDPREFIX;


                theToInit.IMPORTACIONFICHEROSASCII_PAGEHEADER = "Trabajos";
            ...
            var fsCtrlSpecs = function( theIsInstrumentacion) {
                ...
                var aSourceCtrlSpecs = theS_ImportacionficherosasciiCtrlSpecsTobefilled.CTRLSPECS;
                if( !aSourceCtrlSpecs) {
                    return null;
                }
                ...
                var aCsssFilledCtrlSpecs = aFillspecsSvce.fFillSpecsCsss(
                    aSourceCtrlSpecs,
                    theS_CssNames_Springnut_Importacionficherosascii.CSSs_SPRINGNUT_IMPORTACIONFICHEROSASCII_TABLE,
                    theS_CssNames_Springnut_Importacionficherosascii.CSSs_SPRINGNUT_IMPORTACIONFICHEROSASCII_EDITOR);
                ...
                var aRetrievalsFilledCtrlSpecs = aCsssFilledCtrlSpecs;

                /* Set literally in importacionficherosascii_ctrl_specs_tobefilled.js
                ...
                */
                ...
                aCtrlSpecsToReturn.IMPORTACIONFICHEROSASCII_DOMIDPREFIX = aModule.IMPORTACIONFICHEROSASCII_DOMIDPREFIX;
                aCtrlSpecsToReturn.DOMIDPREFIX = aModule.DOMIDPREFIX;

                aCtrlSpecsToReturn.IMPORTACIONFICHEROSASCII_PAGEHEADER =  aModule.IMPORTACIONFICHEROSASCII_PAGEHEADER;
