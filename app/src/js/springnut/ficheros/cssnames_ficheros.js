...
angular.module("cssNames_Springnut_Ficheros", [
        "typesRegistry",
        "cssKeys",
        "cssNames_Springnut"
    ]).
    factory("CssNames_Springnut_Ficheros", [
        "TypesRegistrySvce",
        "CssKeys",
        "CssNames_Springnut",
        function( theSS_typesregistry,
            ...
            var ModuleName     = "cssnames_ficheros";
            ...
            var aMod_definer = function( theS_CssKeys,
                ...
                var pgInitWithModuleConstants = function( theToInit) {
                    ...
                    theToInit.CSSs_SPRINGNUT_FICHEROS_TABLE = { };
                    ...
                    for( var aGridClassKeyIdx=0; aGridClassKeyIdx < aNumGridClassKeys; aGridClassKeyIdx++) {
                        ...
                        theToInit.CSSs_SPRINGNUT_FICHEROS_TABLE[ aGridClassKey] = theS_CssNames_Springnut.CSSs_SPRINGNUT_TABLE[ aGridClassKey];
                    }



                    theToInit.CSSs_SPRINGNUT_FICHEROS_EDITOR = { };
                    ...
                    for( var anEditorClassKeyIdx=0; anEditorClassKeyIdx < aNumEditorClassKeys; anEditorClassKeyIdx++) {
                        ...
                        theToInit.CSSs_SPRINGNUT_FICHEROS_EDITOR[ anEditorClassKey] = theS_CssNames_Springnut.CSSs_SPRINGNUT_EDITOR[ anEditorClassKey];
                    }
                };
