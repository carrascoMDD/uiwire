...
angular.module('fasesvalidacionTypes').controller( 'FasesvalidacionCtrl', [
    'FasesvalidacionCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
function ( theSS_FasesvalidacionCtrlType,
    ...
    $scope.fasesvalidacionCtrl = new theSS_FasesvalidacionCtrlType.FasesvalidacionCtrl_Constructor(
        "Fasesvalidacion_Controller",
        theSS_IdentifierSvce,
        theSS_RecorderSvce,
        $scope,
        null,
    ...
    $scope.compositeCtrl = $scope.fasesvalidacionCtrl;


    $scope.fasesvalidacionCtrl.fprDo_Initial();
