...
angular.module("adminoperadoresTypes").factory("AdminoperadoresSvce", [
    "AdminoperadoresSvceType",
    "IdentifierSvce",
    "RecorderSvce",
function( theSS_AdminoperadoresSvceType,
          theSS_IdentifierSvce,
          theSS_RecorderSvce){

    var aService = new theSS_AdminoperadoresSvceType.AdminoperadoresSvce_Constructor(
        "Adminoperadores_Service",
        theSS_IdentifierSvce,
        theSS_RecorderSvce
    );
    if( aService){}/* CQT */
