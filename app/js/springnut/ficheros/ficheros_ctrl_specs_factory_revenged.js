...
/*
 * ficheros_ctrl_specs_factory_revenged.js
 *
...
angular.module("ficherosTypes").factory("FicherosCtrlSpecsFactoryRevenged", [
    "TypesRegistrySvce",
    "OverriderSvce",
    "IdentifierSvce",
    "RecorderSvce",
    "InferctrlspecsSvceType",
    "FillspecsSvceType",
    "CssKeys",
    "CssNames_Springnut_Ficheros",
    "FicherosRevengSampleData",
function( theSS_typesregistry,
          theSS_Overrider,
          theSS_IdentifierSvce,
          theSS_RecorderSvce,
          theSS_InferctrlspecsSvceType,
          theSS_FillspecsSvceType,
          theSS_CssKeys,
          theSS_CssNames_Springnut_Ficheros,
          theSS_FicherosRevengSampleData) {




    var ModuleName     = "Ficheros_ctrl_specs_factory_revenged";
    ...
    var aMod_definer = function( theS_Overrider,
                                 theS_IdentifierSvce,
                                 theS_RecorderSvce,
                                 theS_InferctrlspecsSvceType,
                                 theS_FillspecsSvceType,
                                 theS_CssKeys,
                                 theS_CssNames_Springnut_Ficheros,
                                 theS_FicherosRevengSampleData) {
        ...
        var pgInitWithModuleVariations = function( theToInit) {
            ...
            theToInit.LOGINFERREDSPECS         = false;
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.DEFAULTTITLE = "FicherosCtrlDefaultName";



            theToInit.FICHEROS_DOMIDPREFIX = "didSpringnut_Ficheros";


            theToInit.FICHEROS_PAGEHEADER = "Ficheros y Boletines";



            theToInit.RETRIEVALTARGET = "fFicherosSvce";


            theToInit.RETRIEVALSFORGRIDNAMES = {
                "ListaFicheros":           "fprDo_Ficheros_ListaFicheros_Wrapper",
                "ListaBoletinesDeFichero": "fprDo_Ficheros_ListaBoletinesDeFichero_Wrapper"
            };
            ...
            theToInit.COLUMNCLASSESPREFIX = "cssSpringnut_Ficheros_";

            theToInit.TYPENAMEPREFIXES = {
            };


            theToInit.FIELDNAMESIGNORED = [
                "vTipo",
                "vSuccess",
                "vDetallesOperacion",
                "vStatusOperacion"
        ...
        var fsCtrlSpecs = function( theIsInstrumentacion) {
            ...
            var aInferctrlspecsSvce = new theS_InferctrlspecsSvceType.InferctrlspecsSvce_Constructor(
                "Inferctrlspecs_Service-For-" + aModule.DEFAULTTITLE,
                theS_IdentifierSvce,
                theS_RecorderSvce
            );

            aInferctrlspecsSvce.pCleanUp();

            var aSampleData = theS_FicherosRevengSampleData.SAMPLEDATA;
            if( aSampleData) {
                aInferctrlspecsSvce.pAddSampleData( aSampleData);
            }

            var aColumnClassesPrefix = aModule.COLUMNCLASSESPREFIX;
            if( aColumnClassesPrefix) {
                aInferctrlspecsSvce.pSetColumnClassesPrefix( aColumnClassesPrefix);
            }

            var someTypeNamePrefixes = aModule.TYPENAMEPREFIXES;
            if( someTypeNamePrefixes) {
                aInferctrlspecsSvce.pSetTypeNamePrefixes( someTypeNamePrefixes);
            }

            var someFieldNamesIgnored = aModule.FIELDNAMESIGNORED;
            if( someFieldNamesIgnored) {
                aInferctrlspecsSvce.pSetFieldNamesIgnored( someFieldNamesIgnored);
            }

            if( !aInferctrlspecsSvce.fPerformInference()) {
                return null;
            }


            var anInferredCtrlSpecs = aInferctrlspecsSvce.fInferredCtrlSpecs();
            if( !anInferredCtrlSpecs) {
                return null;
            }

            if( aModule.LOGINFERREDSPECS) {
                var anInferredCtrlSpecsJSON = JSON.stringify( anInferredCtrlSpecs, null, 4);
                console.log( "INFERREDSPECS\n" + anInferredCtrlSpecsJSON);
            }
            ...
            var aCsssFilledCtrlSpecs = aFillspecsSvce.fFillSpecsCsss(
                anInferredCtrlSpecs,
                theS_CssNames_Springnut_Ficheros.CSSs_SPRINGNUT_FICHEROS_TABLE,
                theS_CssNames_Springnut_Ficheros.CSSs_SPRINGNUT_FICHEROS_EDITOR
            );
            ...
            aCtrlSpecsToReturn.FICHEROS_DOMIDPREFIX = aModule.FICHEROS_DOMIDPREFIX;

            aCtrlSpecsToReturn.FICHEROS_PAGEHEADER =  aModule.FICHEROS_PAGEHEADER;
