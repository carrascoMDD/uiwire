...
/*
 * ficheros_ctrl_specs_factory_explicit.js
 *
...
angular.module("ficherosTypes").factory("FicherosCtrlSpecsFactoryExplicit", [
    "TypesRegistrySvce",
    "OverriderSvce",
    "IdentifierSvce",
    "RecorderSvce",
    ...
    function( theSS_typesregistry,
              ...
              theSS_FicherosCtrlSpecsTobefilled) {




        var ModuleName     = "ficheros_ctrl_specs_factory_explicit";
        ...
        var aMod_definer = function( theS_Overrider,
                                     ...
                                     theS_FicherosCtrlSpecsTobefilled) {
            ...
            var pgInitWithModuleConstants = function( theToInit) {
                ...
                theToInit.FICHEROS_PAGEHEADER = "Ficheros";
            ...
            var fsCtrlSpecs = function( theIsInstrumentacion) {
                ...
                var aSourceCtrlSpecs = theS_FicherosCtrlSpecsTobefilled.CTRLSPECS;
                if( !aSourceCtrlSpecs) {
                    return null;
                }
