...
angular.module("cssNames_Springnut_Edivalidaciones", [
    "typesRegistry",
    "cssKeys",
    "cssNames_Springnut"
]).
factory("CssNames_Springnut_Edivalidaciones", [
    "TypesRegistrySvce",
    "CssKeys",
    "CssNames_Springnut",
function( theSS_typesregistry,
    ...
    var ModuleName     = "cssnames_edivalidaciones";
    ...
    var aMod_definer = function( theS_CssKeys,
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.CSSs_SPRINGNUT_EDIVALIDACIONES_TABLE = { };
            ...
            for( var aGridClassKeyIdx=0; aGridClassKeyIdx < aNumGridClassKeys; aGridClassKeyIdx++) {
                ...
                theToInit.CSSs_SPRINGNUT_EDIVALIDACIONES_TABLE[ aGridClassKey] = theS_CssNames_Springnut.CSSs_SPRINGNUT_TABLE[ aGridClassKey];
            }



            theToInit.CSSs_SPRINGNUT_EDIVALIDACIONES_EDITOR = { };
            ...
            for( var anEditorClassKeyIdx=0; anEditorClassKeyIdx < aNumEditorClassKeys; anEditorClassKeyIdx++) {
                ...
                theToInit.CSSs_SPRINGNUT_EDIVALIDACIONES_EDITOR[ anEditorClassKey] = theS_CssNames_Springnut.CSSs_SPRINGNUT_EDITOR[ anEditorClassKey];
            }
