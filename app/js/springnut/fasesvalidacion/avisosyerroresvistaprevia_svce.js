...
/*
 * avisosyerroresvistaprevia_svce.js
 *
...
angular.module("avisosyerroresvistapreviaTypes").factory("AvisosyerroresvistapreviaSvce", [
    "AvisosyerroresvistapreviaSvceType",
    "IdentifierSvce",
    "RecorderSvce",
function( theSS_AvisosyerroresvistapreviaSvceType,
          theSS_IdentifierSvce,
          theSS_RecorderSvce){

    var aService = new theSS_AvisosyerroresvistapreviaSvceType.AvisosyerroresvistapreviaSvce_Constructor(
        "Avisosyerroresvistaprevia_Service",
        theSS_IdentifierSvce,
        theSS_RecorderSvce
    );
    if( aService){}/* CQT */
