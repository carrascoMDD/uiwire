...
angular.module("cssNames_Springnut_Adminoperadores", [
    "typesRegistry",
    "cssKeys",
    "cssNames_Springnut"
]).
factory("CssNames_Springnut_Adminoperadores", [
    "TypesRegistrySvce",
    "CssKeys",
    "CssNames_Springnut",
function( theSS_typesregistry,
    ...
    var ModuleName     = "cssnames_adminoperadores";
    ...
    var aMod_definer = function( theS_CssKeys,
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.CSSs_SPRINGNUT_ADMINOPERADORES_TABLE = { };
            ...
            for( var aGridClassKeyIdx=0; aGridClassKeyIdx < aNumGridClassKeys; aGridClassKeyIdx++) {
                ...
                theToInit.CSSs_SPRINGNUT_ADMINOPERADORES_TABLE[ aGridClassKey] = theS_CssNames_Springnut.CSSs_SPRINGNUT_TABLE[ aGridClassKey];
            }



            theToInit.CSSs_SPRINGNUT_ADMINOPERADORES_EDITOR = { };
            ...
            for( var anEditorClassKeyIdx=0; anEditorClassKeyIdx < aNumEditorClassKeys; anEditorClassKeyIdx++) {
                ...
                theToInit.CSSs_SPRINGNUT_ADMINOPERADORES_EDITOR[ anEditorClassKey] = theS_CssNames_Springnut.CSSs_SPRINGNUT_EDITOR[ anEditorClassKey];
            }
