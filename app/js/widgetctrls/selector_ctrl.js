...
angular.module('widgetCtrlsTypes').controller( 'SelectorCtrl', [
    'SelectorCtrlType',
    "IdentifierSvce",
    "RecorderSvce",
    '$scope',
function ( theSS_SelectorCtrlType,
    ...
    $scope.selectorCtrl = new theSS_SelectorCtrlType.SelectorCtrl_Constructor(
        "Selector_Controller",
        theSS_IdentifierSvce,
        theSS_RecorderSvce,
        $scope
    ...
    $scope.selectorCtrl.fprDo_Initial();
