...
angular.module('springnut').config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider
        .when('/edivalidacionesInstrumentacion', {templateUrl: 'partials/edivalidaciones/edivalidaciones.html', controller: 'EdivalidacionesInstrumentacionCtrl'})
        .when('/edivalidacionesOperacion',       {templateUrl: 'partials/edivalidaciones/edivalidaciones.html', controller: 'EdivalidacionesOperacionCtrl'})
        ...
        .otherwise({redirectTo: '/edivalidacionesOperacion'});
